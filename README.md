...
cada vencimento da NTN-B Principal. Um robô roda **automaticamente todo dia
...
## Trocando o título ou o ano

No `scripts/gerar_dados_json.py`, altere a variável `ANO` e/ou a `URL` para
apontar para outro arquivo do Tesouro (o link de cada título aparece na
página oficial de [histórico de preços e taxas](https://www.tesourodireto.com.br/produtos/dados-sobre-titulos/historico-de-precos-e-taxas)).
